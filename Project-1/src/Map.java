...
/**
 * Map is a representation of a Map and the Trainer class owns an instance of Map
 *
...
public class Map {
    ...
    /**
     * Constructs a Map object that initializes a 2D char map, a 2D boolean array, and attempts to load file while
     * catching for execption.
     */
    public Map() {
        try {
            this.loadMap(1);
